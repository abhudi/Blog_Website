    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterVM vm)
        {
            ...
            if (result.Succeeded)
            {
                ...
                {
                    await _userManager.AddToRoleAsync(applicationUser, WebsiteRoles.WebsiteAutor);
                }
        ...
        public async Task<IActionResult> Login(LoginVM vm)
        {
            ...
            if (!verifyPassword)
            {
                _notification.Error("Passwrod does not match");
                return View(vm);
            }
        ...
        public IActionResult Logout()
        {
            ...
            _notification.Success("You are logges out successfully");
